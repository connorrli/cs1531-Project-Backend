...
describe('Under normal working conditions', () => {
  test('Success case: When players do not submit any answer', () => {
  ...
  test('Success case: When players do submit an answer and scores are different', () => {
    const answers1Array = playerQuestionInfoRequest(player.playerId, 1).answers;
    answers1 = {
      answer1: answers1Array[0].answerId,
      answer2: answers1Array[1].answerId,
    };
    ...
    answers2 = {
      answer1: answers2Array[0].answerId,
      answer2: answers2Array[1].answerId,
    };
    playerSubmitRequest([answers2.answer2], player.playerId, 2);
  ...
  test('Success case: When players do submit an answer and scores are the same', () => {
    const answers1Array = playerQuestionInfoRequest(player.playerId, 1).answers;
    answers1 = {
      answer1: answers1Array[0].answerId,
      answer2: answers1Array[1].answerId,
...
describe('Throws error under set conditions', () => {
  test('The player ID does not exist', () => {
    ...
    const response = playerResultsRequest(invalidPlayerId);
